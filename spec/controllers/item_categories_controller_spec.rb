  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved item_category as @item_category" do
        ...
        post :create, {:item_category => { "type_sym" => "invalid value" }}, valid_session
        assigns(:item_category).should be_a_new(ItemCategory)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested item_category" do
        ...
        ItemCategory.any_instance.should_receive(:update_attributes).with({ "type_sym" => "MyString" })
        put :update, {:id => item_category.to_param, :item_category => { "type_sym" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the item_category as @item_category" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        ItemCategory.any_instance.stub(:save).and_return(false)
        put :update, {:id => item_category.to_param, :item_category => { "type_sym" => "invalid value" }}, valid_session
        assigns(:item_category).should eq(item_category)
      end
