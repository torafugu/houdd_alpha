  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved specie as @specie" do
        ...
        post :create, {:specie => { "family" => "invalid value" }}, valid_session
        assigns(:specie).should be_a_new(Specie)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested specie" do
        ...
        Specie.any_instance.should_receive(:update_attributes).with({ "family" => "" })
        put :update, {:id => specie.to_param, :specie => { "family" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the specie as @specie" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Specie.any_instance.stub(:save).and_return(false)
        put :update, {:id => specie.to_param, :specie => { "family" => "invalid value" }}, valid_session
        assigns(:specie).should eq(specie)
      end
