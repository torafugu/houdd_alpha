...
describe MobsController do
  ...
  # Mob. As you add validations to Mob, be sure to
  # adjust the attributes here as well.
  let(:valid_attributes) { { "houdd_user" => "" } }

  # This should return the minimal set of values that should be in the session
  # in order to pass any filters (e.g. authentication) defined in
  # MobsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET show" do
    it "assigns the requested mob as @mob" do
      mob = Mob.create! valid_attributes
      get :show, {:id => mob.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested mob as @mob" do
      mob = Mob.create! valid_attributes
      get :edit, {:id => mob.to_param}, valid_session
      assigns(:mob).should eq(mob)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Mob" do
        expect {
          post :create, {:mob => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved mob as @mob" do
        ...
        post :create, {:mob => { "houdd_user" => "invalid value" }}, valid_session
        assigns(:mob).should be_a_new(Mob)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested mob" do
        ...
        Mob.any_instance.should_receive(:update_attributes).with({ "houdd_user" => "" })
        put :update, {:id => mob.to_param, :mob => { "houdd_user" => "" }}, valid_session
      end

      it "assigns the requested mob as @mob" do
        mob = Mob.create! valid_attributes
        put :update, {:id => mob.to_param, :mob => valid_attributes}, valid_session
        assigns(:mob).should eq(mob)
      end
    ...
    describe "with invalid params" do
      it "assigns the mob as @mob" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Mob.any_instance.stub(:save).and_return(false)
        put :update, {:id => mob.to_param, :mob => { "houdd_user" => "invalid value" }}, valid_session
        assigns(:mob).should eq(mob)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested mob" do
      mob = Mob.create! valid_attributes
      expect {
        delete :destroy, {:id => mob.to_param}, valid_session
      }.to change(Mob, :count).by(-1)
    end
